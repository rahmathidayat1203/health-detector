...
class SPO2PAGEADMIN extends StatefulWidget {
  final String uid; // Add the uid as a parameter in the constructor
  SPO2PAGEADMIN({required this.uid, Key? key}) : super(key: key);

  @override
  _SPO2PAGEADMINState createState() => _SPO2PAGEADMINState();
}

class _SPO2PAGEADMINState extends State<SPO2PAGEADMIN> {
