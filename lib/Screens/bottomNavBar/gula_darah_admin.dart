...
class GulaDarahAdmin extends StatefulWidget {
  final String uid; // Add the uid as a parameter in the constructor
  GulaDarahAdmin({required this.uid, Key? key}) : super(key: key);

  @override
  _GulaDarahAdminState createState() => _GulaDarahAdminState();
}

class _GulaDarahAdminState extends State<GulaDarahAdmin> {
