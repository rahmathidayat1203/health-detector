...
class SuhuTubuhGraf extends StatefulWidget {
  const SuhuTubuhGraf({super.key});

  @override
  _SuhuTubuhGrafState createState() => _SuhuTubuhGrafState();
}

class _SuhuTubuhGrafState extends State<SuhuTubuhGraf> {
