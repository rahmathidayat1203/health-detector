...
class HeartRateGraphAdmin extends StatefulWidget {
  ...
  HeartRateGraphAdmin({required this.uid, Key? key}) : super(key: key);

  @override
  _HeartRateGraphAdminState createState() => _HeartRateGraphAdminState();
}

class _HeartRateGraphAdminState extends State<HeartRateGraphAdmin> {
