import 'package:aplikasi_health_detector_rev1/Screens/bottomNavBar/suhu_grafik.dart';
import 'package:flutter/material.dart';
import 'package:firebase_auth/firebase_auth.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:syncfusion_flutter_charts/charts.dart';

import 'SpO2_grafik.dart';
import 'diastolik_grafik.dart';

class SystolicGraph extends StatefulWidget {
  const SystolicGraph({super.key});

  @override
  _SystolicGraphState createState() => _SystolicGraphState();
}

class _SystolicGraphState extends State<SystolicGraph> {
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            Navigator.push(context,
                MaterialPageRoute(builder: ((context) => SuhuTubuhGraf())));
          },
